...
# Divide the workload equally across workers using the SPMD approach
for i in range(n_workers):
    x_start = x_splits[i]
    x_end = x_splits[i + 1]
    # Each worker computes its portion of the integral
...
# Summing the results from each worker to get the total integral
